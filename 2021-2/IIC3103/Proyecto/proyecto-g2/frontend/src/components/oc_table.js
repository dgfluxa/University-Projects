...
export default function OCTable({ data }) {
                    ...
                    <TableBody>
                        {data.map((row) => {
                            if (row.estado.toLowerCase()==='aceptada'){
                                var color = 'green';
                            } else if (row.estado.toLowerCase()==='pendiente'){
                                var color = 'orange';
                            ...
                            <TableRow key={row.oc_id}>
                                ...
                                <TableCell><Button style={{height: 25}} variant="contained" color="secondary" onClick={() => history.push('ftp_ocs/'+row.oc_id)}>Detalles</Button></TableCell>
                            </TableRow>
                        )})}
                    </TableBody>
                </Table>
